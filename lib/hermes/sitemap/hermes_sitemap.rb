module Hermes
  module Sitemap
    ...
    def create_sitemap(sitemap_dir = nil, publication = nil)
      directory = sitemap_dir || SITEMAP_DIR
      create_html_sitemap(directory.without_slash + HTML_SITEMAP, publication)
      create_geo_sitemap(directory.without_slash + GEO_SITEMAP, publication)
      ping_search_engines([HTML_SITEMAP, GEO_SITEMAP]) if RAILS_ENV == "production"
    end
