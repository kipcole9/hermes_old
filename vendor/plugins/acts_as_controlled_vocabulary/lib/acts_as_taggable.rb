    ...
    module Taggable #:nodoc:
      ...
      module InstanceMethods
        ...
        def save_tags
          ...
          # In a controlled vocabulary, :name may be ambiguous depending on the hierarchy
          # of terms.  Therefore we must trace the hierarchy of terms before we take any
          # action to add tags.
          #
          # We delete all current tags because retracing hierarchies from the only the :name
          # isn't possible.
          self.class.transaction do
            self.taggings.delete_all
            tags << Tag.find_controlled_vocabulary(@tag_list)
          end
          true
        end
